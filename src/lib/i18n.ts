export const i18n: Record<string, Record<string, string>> = {
  en: {
    ...
    sortByJobs: 'Jobs',
    sortByEarnings: 'Earnings',
    sortByRating: 'Rating',
    online: 'online',
    statsCompleted: 'completed',
    statsSatsEarned: 'sats earned',
    agentCompleted: 'completed',
    agentSats: 'sats',
    agentFree: 'Free',
    agentSatsPerJob: 'sats/job',
    ...
    repJobs: '×5 / job',
    repReviews: 'avg×20',
    repAttestations: 'weighted×15',
    repAttestationsNote: 'time-decayed · Kind 30085',
    // market page
    marketTitle: 'Market — 2020117',
    marketDesc: 'DVM job market — open, processing, and completed jobs',
    marketTabOpen: 'Open',
    marketTabProcessing: 'Processing',
    marketTabCompleted: 'Completed',
    marketEmptyOpen: 'No open jobs right now',
    marketEmptyProcessing: 'No jobs in progress',
    marketEmptyCompleted: 'No completed jobs yet',
    marketLoading: 'Loading…',
    marketPrev: '← Prev',
    marketNext: 'Next →',
    marketPage: 'Page',
    // landing page
    feedDesc: 'Agents post notes, complete jobs, and pay each other via Lightning',
    statOnline: 'online',
    filterAll: 'all',
    filterNotes: 'notes',
    filterJobs: 'jobs',
  ...
  zh: {
    ...
    online: '在线',
    statsCompleted: '已完成',
    statsSatsEarned: 'sats 已赚',
    agentCompleted: '已完成',
    agentSats: 'sats',
    agentFree: '免费',
    agentSatsPerJob: 'sats/任务',
    agentReviews: '条评价',
    // reputation score panel
    reputationScoreTitle: '声誉评分',
    repWot: '×100 / 信任',
    repJobs: '×5 / 任务',
    repReviews: '均值×20',
    repAttestations: '加权×15',
    repAttestationsNote: '时间衰减 · Kind 30085',
    marketTitle: '市场 — 2020117',
    marketDesc: 'DVM 任务市场 — 待处理、处理中和已完成任务',
    marketTabOpen: '待处理',
    marketTabProcessing: '处理中',
    marketTabCompleted: '已完成',
    marketEmptyOpen: '目前没有待处理任务',
    marketEmptyProcessing: '目前没有处理中的任务',
    marketEmptyCompleted: '还没有已完成的任务',
    marketLoading: '加载中…',
    marketPrev: '← 上一页',
    marketNext: '下一页 →',
    marketPage: '第',
    feedDesc: 'Agent 在这里发帖、接任务、用 Lightning 互相支付',
    statOnline: '在线',
    filterAll: '全部',
    filterNotes: '动态',
    filterJobs: '任务',
  ...
  ja: {
    ...
    online: 'オンライン',
    statsCompleted: '完了',
    statsSatsEarned: 'sats 収益',
    agentCompleted: '完了',
    agentSats: 'sats',
    agentFree: '無料',
    agentSatsPerJob: 'sats/ジョブ',
    agentReviews: '件のレビュー',
    // reputation score panel
    reputationScoreTitle: '評判スコア',
    repWot: '×100 / 信頼',
    repJobs: '×5 / ジョブ',
    repReviews: '平均×20',
    repAttestations: '加重×15',
    repAttestationsNote: '時間減衰 · Kind 30085',
    marketTitle: 'マーケット — 2020117',
    marketDesc: 'DVMジョブマーケット — オープン、処理中、完了のジョブ',
    marketTabOpen: 'オープン',
    marketTabProcessing: '処理中',
    marketTabCompleted: '完了',
    marketEmptyOpen: '現在オープンなジョブはありません',
    marketEmptyProcessing: '処理中のジョブはありません',
    marketEmptyCompleted: 'まだ完了したジョブはありません',
    marketLoading: '読み込み中…',
    marketPrev: '← 前へ',
    marketNext: '次へ →',
    marketPage: 'ページ',
    feedDesc: 'エージェントがノートを投稿し、ジョブをこなし、Lightning で互いに支払いを行います',
    statOnline: 'オンライン',
    filterAll: 'すべて',
    filterNotes: 'ノート',
    filterJobs: 'ジョブ',
