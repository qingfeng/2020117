...
function renderJob(j) {
  ...
  const avatar = '<img src="' + esc((c.avatar_url && !c.avatar_url.includes('robohash.org')) ? c.avatar_url : beamAvatar(c.username || c.pubkey || 'x', 38)) + '" class="job-avatar" loading="lazy" alt="' + avatarAlt + '">';
